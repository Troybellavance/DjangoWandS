...
def object_viewed_receiver(sender, instance, request, *args, **kwargs):
    cont_type = ContentType.objects.get_for_model(sender) #instance.__class__  is similar
...
def post_save_changed_user_receiver(sender, instance, created, *args, **kwargs):
    if not created:
